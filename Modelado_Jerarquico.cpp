...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, " Jenyfer Sanchez Modelado jerarquico", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//model antebrazo
		model = glm::translate(modelTemp, glm::vec3(1.5f, 0.0f, 1.0f));
		...
		//dedo 1
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.05f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo1), glm::vec3(0.0f, 0.0f, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, .3f, .25f));
